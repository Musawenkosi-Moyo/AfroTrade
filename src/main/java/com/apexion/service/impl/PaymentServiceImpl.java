...
import com.apexion.model.PaymentOrder;
import com.apexion.model.User;
import com.apexion.repository.OrderRepository;
import com.apexion.repository.PaymentOrderRepository;
import com.apexion.service.PaymentService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentOrder createOrder(User user, Set<Order> order) {
        ...
        // Creating the order for payment processing
    ...
    public PaymentOrder getPaymentOrderByPaymentId(String orderId) throws Exception {
        ...
        if (paymentOrder == null) {
            throw new Exception("Payment order with provided ID not found");
        }
        return paymentOrder;
    }
