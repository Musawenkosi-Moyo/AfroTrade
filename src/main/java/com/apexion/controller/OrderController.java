...
import com.apexion.response.PaymentLinkResponse;
import com.apexion.service.*;
...
public class OrderController {
    ...
    public ResponseEntity<PaymentLinkResponse> createOrderHandler(
        ...
        //Get the User from the Token and also get their Cart
       ...
       /* if (paymentMethod.equals(PaymentMethod.STRIPE)){
            PaymentLink paymentLink = paymentService.createStripePaymentLink(user,
        ...
        String paymentUrl = paymentService.createRazorPaymentLink(user,
                paymentOrder.getAmount(),
                paymentOrder.getId());
        res.setPayment_link_url(paymentUrl);
    }
    ...
    @GetMapping("/user")
    public ResponseEntity<List<Order>> userOrderHistroryHandler(
            @RequestHeader("Authorization") String jwt) throws Exception {
